...
const AddProduct = props => {
  ...
  const onPhotoSelected = (file) => {
    ...
    reader.onload = function() {
      $("img[name='prod_photo']")[0].src = reader.result;
      productChange('photo', reader.result);
    }
      ...
      <form onSubmit={handleSubmit} noValidate>
        <Row>
          ...
          <Col xs='12' md='12'>
            ...
            />
            <img name='prod_photo'
              src={productFormData.photo ? productFormData.photo : '/images/default_image.png'} 
              style={{width: 150, height:150, cursor: 'pointer'}} 
              onClick={onPhotoBtnClick} />
            <Button className='btn-default' text="Select" 
